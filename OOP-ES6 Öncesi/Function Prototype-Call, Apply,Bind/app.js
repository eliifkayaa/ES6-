//Fonksiyon prototypende bulunan fonksiyonlarımız.
...
addNumbers.call(obj1, 100,200); //önce bir obje vermek zorundayız.
...
//Bind = bir fonksiyonu bir objeye bağlıyoruz.
function getNumbersTotal(number3, number4) {
    return this.number1 + this.number2 + number3 +number4
}

//this anahtar kelimesinin karıştığı yerler de bind kullanılır.
